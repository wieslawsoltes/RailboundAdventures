...
export const PRIMITIVES={box:boxGeometry(),cylinder:cylinderGeometry(18),cone:cylinderGeometry(12,0),sphere:sphereGeometry(),pine:pineGeometry(),pineFar:pineFarGeometry(),foliage:foliageGeometry(),body:bodyGeometry(),nose:noseGeometry()};
...
export class SceneBuilder {
 ...
 finish(){const lod=[];for(const b of this.cells.values()){b.finish();if(b.geometry===this.geometry.pine){b.lodNear=600;const far=new Batch(this.geometry.pineFar,{center:b.center,radius:b.radius,maxDistance:b.maxDistance});far.data=b.data;far.count=b.count;far.lodFar=600;lod.push(far);}}this.batches.push(...lod);this.cells.clear();return this.batches;}
}
